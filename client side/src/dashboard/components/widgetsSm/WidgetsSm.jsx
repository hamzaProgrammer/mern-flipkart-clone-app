...
import { Box, Typography , Grid , Button , List , ListItem , ListItemText , Menu , MenuItem} from '@mui/material'
            ...
            <Box className={classes.root}>
                ...
                {/* {
                    newUsers ?  (
                        ...
                        <Grid container  className={classes.mainGrid}>
                                    <Grid item xs={2}>
                                        <img
                                            src={"data:image/jpeg;base64," }
                                            alt="User Profile Cover"
                                            width="100%"
                                            height="100%"
                                            className={classes.image}
                                    ...
                                    <Grid item xs={7}>
                                        <Box className={classes.middle}>
                                            <Typography style={{fontSize:'17px', fontWeight: 600}}  >Hamza</Typography>
                                            <Typography style={{fontSize:'15px', fontWeight: 400 , color: 'grey'}}>hjsjdash@gmail.cpm</Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={3}>
                                        <Button
                ...
                <Grid container  className={classes.mainGrid}>
                                    ...
                                    <Grid item xs={7}>
                                        <Box className={classes.middle}>
                                            <Typography style={{fontSize:'17px', fontWeight: 600}}  >hamza</Typography>
                                            <Typography style={{fontSize:'15px', fontWeight: 400 , color: 'grey'}}>hmaq@gmail.com</Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={3}>
                                        <Button
